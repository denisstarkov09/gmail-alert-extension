    ...
    return (
      <div>
        ...
        <div className="platform-item">
          ...
          <Row>
            <Form.Group id="formGridInput">
              <Form.Label>Select Domain:</Form.Label>
              <Form.Control type='text' placeholder='Domain' name='domain' value={this.state.domain} onChange={this.handleDomain} />
            </Form.Group>
          </Row>
